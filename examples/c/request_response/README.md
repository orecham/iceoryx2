...
```sh
./target/ffi/cxx/build/examples/c/request_response/example_c_request_response_client
```

### Terminal 2

```sh
./target/ffi/cxx/build/examples/c/request_response/example_c_request_response_server
```
