...
```sh
./target/ffi/cxx/build/examples/c/service_attributes/example_c_service_attributes_creator
```

### Terminal 2

```sh
./target/ffi/cxx/build/examples/c/service_attributes/example_c_service_attributes_opener
```

### Terminal 3

```sh
./target/ffi/cxx/build/examples/c/service_attributes/example_c_service_attributes_incompatible
```
