...
```sh
./target/ffi/cxx/build/examples/cxx/request_response_dynamic_data/example_cxx_request_response_dyn_server
```

### Terminal 2

```sh
./target/ffi/cxx/build/examples/cxx/request_response_dynamic_data/example_cxx_request_response_dyn_client
```
