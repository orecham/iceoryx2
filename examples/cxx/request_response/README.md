...
```sh
./target/ffi/cxx/build/examples/cxx/request_response/example_cxx_request_response_server
```

### Terminal 2

```sh
./target/ffi/cxx/build/examples/cxx/request_response/example_cxx_request_response_client
```
